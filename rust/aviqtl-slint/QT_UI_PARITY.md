...
- The object-settings window now projects the selected clip's real effect stack and metadata-defined
  ...
  Native hit-area and pointer-feel verification remains deferred. Native file/color/font pickers
  remain incomplete and therefore keep this area at `foundation`.
