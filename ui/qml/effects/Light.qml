...
Common.BaseEffect {
    ...
    property real lightPositionX: Math.max(0, Math.min(100, root.evalNumber("x", 50)))
    property real lightPositionY: Math.max(0, Math.min(100, root.evalNumber("y", 50)))
    ...
    ShaderEffect {
        ...
        property real lightX: root.lightPositionX / 100.0
        property real lightY: root.lightPositionY / 100.0
