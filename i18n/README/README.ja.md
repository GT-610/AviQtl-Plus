...
> [!IMPORTANT]
> このリポジトリは[taisho-guy/AviQtl](https://codeberg.org/taisho-guy/AviQtl)のforkです。元プロジェクトは2026年5月末に開発を停止しました。元プロジェクトの初期コアコントリビューターであった[GT610](https://github.com/GT-610)が開発を引き継ぎ、**AviQtl-Plus**として継続します。
