...
class ProjectSerializer {
  public:
    static QVariantMap captureSnapshot(UI::TimelineService *timeline,
    ...
    static auto save(const QString &fileUrl, UI::TimelineService *timeline,
                     const UI::ProjectService *project, QString *errorMessage = nullptr) -> bool;
