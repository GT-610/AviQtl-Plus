...
[既にあるイシューを確認](https://codeberg.org/taisho-guy/AviQtl/issues)して下さい。もし、あなたが望む情報がなければ[イシューを作成](https://codeberg.org/taisho-guy/AviQtl/issues/new)して下さい。
 
## 貢献

開発への参加を歓迎します！詳しくは`CONTRIBUTING.md`をご覧ください。
実装はもちろん、ドキュメントの拡充や翻訳などでも貢献できます。

## 主要貢献者

### [taisho-guy](https://codeberg.org/taisho-guy)

- AviQtl（旧Rina）の発案者、管理者
- Linuxビルドの保守
- コア（ECS等）やUIの実装
- ドキュメント、ホームページの保守

### [GT610](https://codeberg.org/GT610)

- 外部コントリビューター
- Windows / macOSビルドの開通、修正
- デコーダー、エンコーダーの最適化
- 翻訳ファイル（en-US、zh-CN）の提供
